...
class CircularDoublyLinkedList extends DoubleLinkedList{
    push(element){
        const node = this.createNode(element)
...
list2.print()
console.log("####### CIRCULAR DOUBLY LINKEDLIST OUTPUT #########")
const list3 = new CircularDoublyLinkedList()
list3.push(10)
list3.push(20)
list3.push(30)
list3.push(0)
list3.push(100,list3.size)
list3.remove(0)
